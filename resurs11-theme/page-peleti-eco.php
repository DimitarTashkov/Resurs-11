<?php
/* Template Name: Peleti Eco */
get_header();
?>
<!-- HERO -->
<section class="relative pt-32 pb-16 bg-[#2c3036] text-white overflow-hidden">
  <img src="<?php echo get_template_directory_uri(); ?>/images/background essentials/bg7.jpg" alt="" class="absolute inset-0 w-full h-full object-cover opacity-20" loading="eager"/>
  <div class="absolute inset-0 bg-gradient-to-br from-brand-dark via-brand-dark/80 to-brand-brown/40"></div>
  <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    <span class="inline-block bg-brand-brown/30 border border-brand-brown text-brand-brownLt text-sm font-semibold uppercase tracking-widest px-5 py-2 rounded-full mb-6">Дървесни пелети</span>
    <h1 class="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight mb-4">Пелети <span class="text-brand-orange">ECO</span></h1>
    <p class="text-xl text-gray-300 max-w-2xl mx-auto">Екологични дървесни пелети с нисък въглероден отпечатък</p>
  </div>
</section>

<!-- BREADCRUMB -->
<div class="bg-brand-ltGray border-b border-gray-200"><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4"><nav class="flex items-center gap-2 text-sm text-gray-500"><a href="<?php echo home_url(); ?>" class="hover:text-brand-orange transition-colors">Начало</a><span>/</span><a href="<?php echo home_url('/produkti/'); ?>" class="hover:text-brand-orange transition-colors">Продукти</a><span>/</span><span class="text-brand-dark font-medium">Пелети ECO</span></nav></div></div>
  ...
  <div class="flex flex-col lg:flex-row gap-10">
    ...
    <!-- SIDEBAR -->
        ...
        <div class="sticky top-28 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm max-h-[calc(100vh-8rem)] overflow-y-auto">
          ...
          <nav class="flex flex-col gap-1 mb-4">
            ...
            <a href="<?php echo home_url('/peleti-eco/'); ?>" class="px-3 py-2 rounded-lg text-brand-orange bg-brand-ltGray font-bold text-sm transition-colors">Пелети ECO</a>
          </nav>
        </div>
      </aside>
    ...
    <main class="w-full lg:w-3/4 flex flex-col gap-16 pb-20">
      ...
      <section class="bg-brand-cream rounded-2xl py-8">
        ...
        <img src="<?php echo get_template_directory_uri(); ?>/images/products/eco.png" alt="Дървесни пелети ECO" class="w-full h-[400px] lg:h-[500px] object-contain bg-white" />
      </div>
            <div class="flex flex-col h-full">
              <div class="mb-6">
                ...
                <h2 class="text-3xl sm:text-4xl font-extrabold text-brand-dark mb-6">Пелети ECO</h2>
                <p class="text-gray-500 text-lg leading-relaxed mb-8">Екологични дървесни пелети с нисък въглероден отпечатък. Подходящи за екологично съзнателни клиенти, които искат да отопляват домовете си без да натоварват околната среда. Произведени от устойчиво управлявани горски ресурси.</p>
              </div>
          ...
          <table class="w-full text-sm">
            <tbody>
              <tr class="border-b border-gray-100"><td class="py-3 text-gray-500 font-medium">Тип</td><td class="py-3 text-brand-dark font-semibold text-right">Екологични</td></tr>
              <tr class="border-b border-gray-100"><td class="py-3 text-gray-500 font-medium">Въглероден отпечатък</td><td class="py-3 text-brand-dark font-semibold text-right">Нисък</td></tr>
              ...
              <tr class="border-b border-gray-100"><td class="py-3 text-gray-500 font-medium">Материал</td><td class="py-3 text-brand-dark font-semibold text-right">Устойчива дървесина</td></tr>
              <tr><td class="py-3 text-gray-500 font-medium">Произход</td><td class="py-3 text-brand-dark font-semibold text-right">Устойчиви гори</td></tr>
            </tbody>
          </table>
              </div>
              <div class="mb-8">
                ...
                <ul class="space-y-3">
          <li class="flex items-center gap-3 text-gray-600"><svg class="w-5 h-5 text-brand-orange flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>Нисък въглероден отпечатък</li>
          <li class="flex items-center gap-3 text-gray-600"><svg class="w-5 h-5 text-brand-orange flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>Произведени от устойчиви ресурси</li>
          <li class="flex items-center gap-3 text-gray-600"><svg class="w-5 h-5 text-brand-orange flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>Чисто и ефективно горене</li>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      <article class="product-card bg-white rounded-2xl overflow-hidden border border-gray-100"><div class="relative overflow-hidden h-48"><img src="<?php echo get_template_directory_uri(); ?>/images/products/wolf.png" alt="Пелети WOLF" class="w-full h-full object-contain hover:scale-105 transition-transform duration-500" loading="lazy"/><span class="absolute top-3 left-3 bg-brand-brown text-white text-xs font-bold px-3 py-1.5 rounded-full">Дървесни</span></div><div class="p-5"><h3 class="font-bold text-lg text-brand-dark mb-2">Пелети WOLF</h3><p class="text-gray-500 text-sm mb-4">ENplus сертифицирани с минимална пепел.</p><a href="<?php echo home_url('/peleti-wolf/'); ?>" class="inline-flex items-center gap-2 text-brand-orange hover:text-brand-orangeHov font-semibold text-sm transition-colors">Виж повече →</a></div></article>
      <article class="product-card bg-white rounded-2xl overflow-hidden border border-gray-100"><div class="relative overflow-hidden h-48"><img src="<?php echo get_template_directory_uri(); ?>/images/products/tron.png" alt="Пелети TRON" class="w-full h-full object-contain hover:scale-105 transition-transform duration-500" loading="lazy"/><span class="absolute top-3 left-3 bg-brand-brown text-white text-xs font-bold px-3 py-1.5 rounded-full">Дървесни</span></div><div class="p-5"><h3 class="font-bold text-lg text-brand-dark mb-2">Пелети TRON</h3><p class="text-gray-500 text-sm mb-4">100% дървесина без добавки. Отлично съотношение цена-качество.</p><a href="<?php echo home_url('/peleti-tron/'); ?>" class="inline-flex items-center gap-2 text-brand-orange hover:text-brand-orangeHov font-semibold text-sm transition-colors">Виж повече →</a></div></article>
      <article class="product-card bg-white rounded-2xl overflow-hidden border border-gray-100"><div class="relative overflow-hidden h-48"><img src="<?php echo get_template_directory_uri(); ?>/images/products/pjs.png" alt="Пелети PJS" class="w-full h-full object-contain hover:scale-105 transition-transform duration-500" loading="lazy"/><span class="absolute top-3 left-3 bg-brand-brown text-white text-xs font-bold px-3 py-1.5 rounded-full">Дървесни</span></div><div class="p-5"><h3 class="font-bold text-lg text-brand-dark mb-2">Пелети PJS</h3><p class="text-gray-500 text-sm mb-4">Надежден избор за ежедневно отопление.</p><a href="<?php echo home_url('/peleti-pjs/'); ?>" class="inline-flex items-center gap-2 text-brand-orange hover:text-brand-orangeHov font-semibold text-sm transition-colors">Виж повече →</a></div></article>
    </div>
...
<!-- CTA -->
<section class="py-16 bg-[#2c3036] text-white"><div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center"><h2 class="text-3xl sm:text-4xl font-extrabold mb-4">Заинтересовани ли сте от пелети ECO?</h2><p class="text-gray-400 text-lg mb-8 max-w-xl mx-auto">Свържете се с нас за актуални цени, наличност и условия за доставка.</p><div class="flex flex-col sm:flex-row gap-4 justify-center"><a href="tel:+359877300310" class="bg-brand-orange hover:bg-brand-orangeHov text-white font-bold px-8 py-4 rounded-xl text-lg transition-colors">📞 +359 877 300 310</a><a href="<?php echo home_url('/kontakti/'); ?>" class="bg-white/10 hover:bg-white/20 border border-white/30 text-white font-bold px-8 py-4 rounded-xl text-lg transition-colors">Изпрати запитване</a></div></div></section>

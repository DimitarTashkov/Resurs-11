...
<div class="bg-brand-ltGray border-b border-gray-200">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
    <nav class="flex items-center gap-2 text-sm text-gray-500">
      ...
      <span>/</span>
      <span class="text-brand-dark font-medium">Пелети AHIRA</span>
    </nav>
  </div>
</div>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <!-- SIDEBAR -->
        ...
        <div class="sticky top-28 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm max-h-[calc(100vh-8rem)] overflow-y-auto">
          ...
          <nav class="flex flex-col gap-1 mb-4">
            ...
            <a href="<?php echo home_url('/peleti-ahira/'); ?>" class="px-3 py-2 rounded-lg text-brand-orange bg-brand-ltGray font-bold text-sm transition-colors">Пелети AHIRA</a>
        ...
        <div class="px-4 sm:px-6 lg:px-8">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div class="rounded-2xl overflow-hidden shadow-lg border border-gray-100">
              <img src="<?php echo get_template_directory_uri(); ?>/images/products/peleti-ahira.png" alt="Дървесни Пелети AHIRA" class="w-full h-[400px] lg:h-[500px] object-contain bg-white" />
            </div>
            <div class="flex flex-col h-full">
              <div class="mb-6">
                ...
                <h2 class="text-3xl sm:text-4xl font-extrabold text-brand-dark mb-6">Пелети AHIRA</h2>
  ...
  <div class="bg-brand-orange/5 rounded-xl p-4 border border-brand-orange/20">
    ...
    <div class="flex items-baseline gap-1">
      <span class="text-2xl font-bold text-brand-orange">320.00 EUR</span>
      <span class="text-gray-400 text-sm font-semibold">/ 625.87 BGN</span>
    </div>
  </div>
  <div class="bg-brand-orange/5 rounded-xl p-4 border border-brand-orange/20">
    <p class="text-sm text-gray-500 mb-1">Цена на чувал</p>
    <div class="flex items-baseline gap-1">
      <span class="text-2xl font-bold text-brand-orange">5.20 EUR</span>
      <span class="text-gray-400 text-sm font-semibold">/ 10.17 BGN</span>
    </div>
  </div>
...
<section class="py-16 bg-[#2c3036] text-white">
  <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    <h2 class="text-3xl sm:text-4xl font-extrabold mb-4">Заинтересовани ли сте от Пелети AHIRA?</h2>

    ...
    <!-- SIDEBAR -->
        ...
        <div class="sticky top-28 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm max-h-[calc(100vh-8rem)] overflow-y-auto">
          ...
          <nav class="flex flex-col gap-1 mb-4">
            ...
            <a href="<?php echo home_url('/peleti-pjs/'); ?>" class="px-3 py-2 rounded-lg text-brand-orange bg-brand-ltGray font-bold text-sm transition-colors">Пелети PJS</a>
        ...
        <div class="px-4 sm:px-6 lg:px-8">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div class="rounded-2xl overflow-hidden shadow-lg border border-gray-100">
              <img src="<?php echo get_template_directory_uri(); ?>/images/products/pjs.png" alt="Дървесни пелети PJS" class="w-full h-[400px] lg:h-[500px] object-contain bg-white" />
            </div>
            <div class="flex flex-col h-full">
              <div class="mb-6">
                ...
                <h2 class="text-3xl sm:text-4xl font-extrabold text-brand-dark mb-6">Пелети PJS</h2>
                <p class="text-gray-500 text-lg leading-relaxed mb-8">Надежден избор за ежедневно отопление. Висока калоричност и стабилно качество през целия сезон. PJS пелетите осигуряват постоянна топлина и лесна поддръжка на вашето пелетно оборудване.</p>
              </div>
              ...
              <div class="bg-white rounded-xl border border-gray-100 p-6 shadow-sm overflow-x-auto mb-6">
                ...
                <table class="w-full text-sm">
                  <tbody>
                    <tr class="border-b border-gray-100"><td class="py-3 text-gray-500 font-medium">Калоричност</td><td class="py-3 text-brand-dark font-semibold text-right">Висока</td></tr>
                    <tr class="border-b border-gray-100"><td class="py-3 text-brand-dark font-medium">Диаметър</td><td class="py-3 text-brand-dark font-semibold text-right">6 мм</td></tr>
                    <tr class="border-b border-gray-100"><td class="py-3 text-gray-500 font-medium">Опаковка</td><td class="py-3 text-brand-dark font-semibold text-right">Чували 15 кг</td></tr>
                    <tr class="border-b border-gray-100"><td class="py-3 text-gray-500 font-medium">Наличност</td><td class="py-3 text-brand-dark font-semibold text-right">На палети</td></tr>
              ...
              <div class="mb-8">
                ...
                <ul class="space-y-3">
                <li class="flex items-center gap-3 text-gray-600"><svg class="w-5 h-5 text-brand-orange flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>Стабилно качество целогодишно</li>
                <li class="flex items-center gap-3 text-gray-600"><svg class="w-5 h-5 text-brand-orange flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>Удобни чували по 15 кг</li>
                <li class="flex items-center gap-3 text-gray-600"><svg class="w-5 h-5 text-brand-orange flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>Налични на палети за поръчки на едро</li>
...
<!-- CTA -->
<section class="py-16 bg-[#2c3036] text-white"><div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center"><h2 class="text-3xl sm:text-4xl font-extrabold mb-4">Заинтересовани ли сте от пелети PJS?</h2><p class="text-gray-400 text-lg mb-8 max-w-xl mx-auto">Свържете се с нас за актуални цени, наличност и условия за доставка.</p><div class="flex flex-col sm:flex-row gap-4 justify-center"><a href="tel:+359877300310" class="bg-brand-orange hover:bg-brand-orangeHov text-white font-bold px-8 py-4 rounded-xl text-lg transition-colors">📞 +359 877 300 310</a><a href="<?php echo home_url('/kontakti/'); ?>" class="bg-white/10 hover:bg-white/20 border border-white/30 text-white font-bold px-8 py-4 rounded-xl text-lg transition-colors">Изпрати запитване</a></div></div></section>

  ...
  <section class="relative pt-32 pb-16 bg-[#2c3036] text-white overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      <h1 class="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight mb-4">Пелети <span
          class="text-brand-orange">SUN Class A2</span></h1>
  ...
  <div class="bg-brand-ltGray border-b border-gray-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
      <nav class="flex items-center gap-2 text-sm text-gray-500">
        ...
        <span>/</span>
        <span class="text-brand-dark font-medium">Пелети SUN Class A2</span>
      </nav>
    </div>
  </div>
<!-- LAYOUT CONTAINER -->
    ...
    <!-- SIDEBAR -->
        ...
        <div class="sticky top-28 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm max-h-[calc(100vh-8rem)] overflow-y-auto">
          ...
          <nav class="flex flex-col gap-1 mb-4">
            ...
            <a href="<?php echo home_url('/peleti-sun-a2/'); ?>" class="px-3 py-2 rounded-lg text-brand-orange bg-brand-ltGray font-bold text-sm transition-colors">Пелети SUN class A2</a>
...
<section class="py-16 bg-[#2c3036] text-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      <h2 class="text-3xl sm:text-4xl font-extrabold mb-4">Заинтересовани ли сте от пелети SUN Class A2?</h2>

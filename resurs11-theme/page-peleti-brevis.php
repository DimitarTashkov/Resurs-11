...
<section class="relative pt-32 pb-16 bg-[#2c3036] text-white overflow-hidden">
  ...
  <div class="absolute inset-0 bg-gradient-to-br from-brand-dark via-brand-dark/80 to-brand-orange/20"></div>
  <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    <span class="inline-block bg-brand-orange/20 border border-brand-orange text-brand-orange text-sm font-semibold uppercase tracking-widest px-5 py-2 rounded-full mb-6">Слънчогледови пелети</span>
    <h1 class="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight mb-4">Пелети <span class="text-brand-orange">BREVIS</span></h1>
    <p class="text-xl text-gray-300 max-w-2xl mx-auto">Икономично решение с висока енергийна стойност</p>
  </div>
</section>

<!-- BREADCRUMB -->
<div class="bg-brand-ltGray border-b border-gray-200"><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4"><nav class="flex items-center gap-2 text-sm text-gray-500"><a href="<?php echo home_url(); ?>" class="hover:text-brand-orange transition-colors">Начало</a><span>/</span><a href="<?php echo home_url('/produkti/'); ?>" class="hover:text-brand-orange transition-colors">Продукти</a><span>/</span><a href="peleti.html#slunchogledovi" class="hover:text-brand-orange transition-colors">Слънчогледови пелети</a><span>/</span><span class="text-brand-dark font-medium">Пелети BREVIS</span></nav></div></div>
    ...
    <!-- SIDEBAR -->
        ...
        <div class="sticky top-28 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm max-h-[calc(100vh-8rem)] overflow-y-auto">
          ...
          <nav class="flex flex-col gap-1 mb-4">
            ...
            <a href="<?php echo home_url('/peleti-brevis/'); ?>" class="px-3 py-2 rounded-lg text-brand-orange bg-brand-ltGray font-bold text-sm transition-colors">Пелети Brevis</a>
        ...
        <div class="px-4 sm:px-6 lg:px-8">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div class="rounded-2xl overflow-hidden shadow-lg border border-gray-100">
              <img src="<?php echo get_template_directory_uri(); ?>/images/products/brevis.png" alt="Слънчогледови пелети BREVIS" class="w-full h-[400px] lg:h-[500px] object-contain bg-white" />
            </div>
            <div class="flex flex-col h-full">
              <div class="mb-6">
                ...
                <h2 class="text-3xl sm:text-4xl font-extrabold text-brand-dark mb-6">Пелети BREVIS</h2>
                <p class="text-gray-500 text-lg leading-relaxed mb-8">Икономично решение с висока енергийна стойност. Налични в чували или насипно за големи количества. BREVIS пелетите са идеалният избор за клиенти, които търсят качествен слънчогледов пелет на достъпна цена с възможност за доставка на едро.</p>
              </div>
              ...
              <div class="bg-white rounded-xl border border-gray-100 p-6 shadow-sm overflow-x-auto mb-6">
                ...
                <table class="w-full text-sm">
                  <tbody>
                    <tr class="border-b border-gray-100"><td class="py-3 text-gray-500 font-medium">Материал</td><td class="py-3 text-brand-dark font-semibold text-right">Слънчогледови люспи и стъбла</td></tr>
                    <tr class="border-b border-gray-100"><td class="py-3 text-gray-500 font-medium">Енергийна стойност</td><td class="py-3 text-brand-dark font-semibold text-right">Висока</td></tr>
                    <tr class="border-b border-gray-100"><td class="py-3 text-gray-500 font-medium">Опаковка</td><td class="py-3 text-brand-dark font-semibold text-right">Чували / Насипно</td></tr>
                    <tr><td class="py-3 text-gray-500 font-medium">Ценови клас</td><td class="py-3 text-brand-dark font-semibold text-right">Икономичен</td></tr>
                  </tbody>
                </table>
              </div>
              <div class="mb-8">
                ...
                <ul class="space-y-3">
                <li class="flex items-center gap-3 text-gray-600"><svg class="w-5 h-5 text-brand-orange flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>Висока енергийна стойност на конкурентна цена</li>
                <li class="flex items-center gap-3 text-gray-600"><svg class="w-5 h-5 text-brand-orange flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>Налични в чували или насипно</li>
                <li class="flex items-center gap-3 text-gray-600"><svg class="w-5 h-5 text-brand-orange flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>Идеални за големи количества</li>
      ...
      <section class="py-16 bg-brand-ltGray rounded-2xl">
        <div class="px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8">
            <article class="product-card bg-white rounded-2xl overflow-hidden border border-gray-100"><div class="relative overflow-hidden h-48"><img src="<?php echo get_template_directory_uri(); ?>/images/products/kerpi.png" alt="Пелети Kerpi" class="w-full h-full object-contain hover:scale-105 transition-transform duration-500" loading="lazy"/><span class="absolute top-3 left-3 bg-brand-orange text-white text-xs font-bold px-3 py-1.5 rounded-full">Слънчогледови</span></div><div class="p-5"><h3 class="font-bold text-lg text-brand-dark mb-2">Пелети Kerpi</h3><p class="text-gray-500 text-sm mb-4">Слънчогледови пелети с отлична калоричност.</p><a href="<?php echo home_url('/peleti-kerpi/'); ?>" class="inline-flex items-center gap-2 text-brand-orange hover:text-brand-orangeHov font-semibold text-sm transition-colors">Виж повече →</a></div></article>
...
<!-- CTA -->
<section class="py-16 bg-[#2c3036] text-white"><div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center"><h2 class="text-3xl sm:text-4xl font-extrabold mb-4">Заинтересовани ли сте от пелети BREVIS?</h2><p class="text-gray-400 text-lg mb-8 max-w-xl mx-auto">Свържете се с нас за актуални цени, наличност и условия за доставка.</p><div class="flex flex-col sm:flex-row gap-4 justify-center"><a href="tel:+359877300310" class="bg-brand-orange hover:bg-brand-orangeHov text-white font-bold px-8 py-4 rounded-xl text-lg transition-colors">📞 +359 877 300 310</a><a href="<?php echo home_url('/kontakti/'); ?>" class="bg-white/10 hover:bg-white/20 border border-white/30 text-white font-bold px-8 py-4 rounded-xl text-lg transition-colors">Изпрати запитване</a></div></div></section>

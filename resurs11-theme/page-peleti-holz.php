...
<div class="bg-brand-ltGray border-b border-gray-200">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
    <nav class="flex items-center gap-2 text-sm text-gray-500">
      ...
      <span>/</span>
      <span class="text-brand-dark font-medium">Пелети Holz</span>
    </nav>
  </div>
</div>
    ...
    <!-- SIDEBAR -->
        ...
        <div class="sticky top-28 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm max-h-[calc(100vh-8rem)] overflow-y-auto">
          ...
          <nav class="flex flex-col gap-1 mb-4">
            ...
            <a href="<?php echo home_url('/peleti-holz/'); ?>" class="px-3 py-2 rounded-lg text-brand-orange bg-brand-ltGray font-bold text-sm transition-colors">Пелети Holz</a>
        ...
        <div class="px-4 sm:px-6 lg:px-8">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div class="rounded-2xl overflow-hidden shadow-lg border border-gray-100">
              <img src="<?php echo get_template_directory_uri(); ?>/images/products/peleti-holz.png" alt="Дървесни Пелети Holz" class="w-full h-[400px] lg:h-[500px] object-contain bg-white" />
            </div>
            <div class="flex flex-col h-full">
              <div class="mb-6">
                ...
                <h2 class="text-3xl sm:text-4xl font-extrabold text-brand-dark mb-6">Пелети Holz</h2>
...
<section class="py-16 bg-[#2c3036] text-white">
  <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    <h2 class="text-3xl sm:text-4xl font-extrabold mb-4">Заинтересовани ли сте от Пелети Holz?</h2>

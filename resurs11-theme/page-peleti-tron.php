    ...
    <!-- SIDEBAR -->
        ...
        <div class="sticky top-28 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm max-h-[calc(100vh-8rem)] overflow-y-auto">
          ...
          <nav class="flex flex-col gap-1 mb-4">
            ...
            <a href="<?php echo home_url('/peleti-tron/'); ?>" class="px-3 py-2 rounded-lg text-brand-orange bg-brand-ltGray font-bold text-sm transition-colors">Пелети TRON</a>
        ...
        <div class="px-4 sm:px-6 lg:px-8">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div class="rounded-2xl overflow-hidden shadow-lg border border-gray-100">
              <img src="<?php echo get_template_directory_uri(); ?>/images/products/tron.png" alt="Дървесни пелети TRON" class="w-full h-[400px] lg:h-[500px] object-contain bg-white" />
            </div>
            <div class="flex flex-col h-full">
              <div class="mb-6">
                ...
                <h2 class="text-3xl sm:text-4xl font-extrabold text-brand-dark mb-6">Пелети TRON</h2>
                <p class="text-gray-500 text-lg leading-relaxed mb-8">Съотношение цена-качество на високо ниво. Произведени от 100% дървесина без добавки. TRON пелетите са перфектният избор за клиенти, които търсят качествен продукт на достъпна цена. Гарантирано чисто горене и минимална пепел.</p>
              </div>
              ...
              <div class="bg-white rounded-xl border border-gray-100 p-6 shadow-sm overflow-x-auto mb-6">
                ...
                <table class="w-full text-sm">
                  <tbody>
                    <tr class="border-b border-gray-100"><td class="py-3 text-gray-500 font-medium">Материал</td><td class="py-3 text-brand-dark font-semibold text-right">100% дървесина</td></tr>
                    ...
                    <tr><td class="py-3 text-gray-500 font-medium">Горене</td><td class="py-3 text-brand-dark font-semibold text-right">Чисто и ефективно</td></tr>
                  </tbody>
                </table>
              </div>
              <div class="mb-8">
      ...
      <section class="py-16 bg-brand-ltGray rounded-2xl">
        <div class="px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8">
            ...
            <article class="product-card bg-white rounded-2xl overflow-hidden border border-gray-100"><div class="relative overflow-hidden h-48"><img src="<?php echo get_template_directory_uri(); ?>/images/products/eco.png" alt="Пелети ECO" class="w-full h-full object-contain hover:scale-105 transition-transform duration-500" loading="lazy"/><span class="absolute top-3 left-3 bg-brand-brown text-white text-xs font-bold px-3 py-1.5 rounded-full">Дървесни</span></div><div class="p-5"><h3 class="font-bold text-lg text-brand-dark mb-2">Пелети ECO</h3><p class="text-gray-500 text-sm mb-4">Екологични пелети с нисък въглероден отпечатък.</p><a href="<?php echo home_url('/peleti-eco/'); ?>" class="inline-flex items-center gap-2 text-brand-orange hover:text-brand-orangeHov font-semibold text-sm transition-colors">Виж повече →</a></div></article>
...
<!-- CTA -->
<section class="py-16 bg-[#2c3036] text-white"><div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center"><h2 class="text-3xl sm:text-4xl font-extrabold mb-4">Заинтересовани ли сте от пелети TRON?</h2><p class="text-gray-400 text-lg mb-8 max-w-xl mx-auto">Свържете се с нас за актуални цени, наличност и условия за доставка.</p><div class="flex flex-col sm:flex-row gap-4 justify-center"><a href="tel:+359877300310" class="bg-brand-orange hover:bg-brand-orangeHov text-white font-bold px-8 py-4 rounded-xl text-lg transition-colors">📞 +359 877 300 310</a><a href="<?php echo home_url('/kontakti/'); ?>" class="bg-white/10 hover:bg-white/20 border border-white/30 text-white font-bold px-8 py-4 rounded-xl text-lg transition-colors">Изпрати запитване</a></div></div></section>

<?php
/**
 * Taxonomy template for produkt_kategoria
 */
get_header();
?>
<!-- PAGE HERO -->
<section class="relative pt-32 pb-20 bg-[#2c3036] text-white overflow-hidden">
  <img src="<?php echo get_template_directory_uri(); ?>/images/background essentials/bg2.jpg" alt="<?php single_term_title(); ?>" class="absolute inset-0 w-full h-full object-cover opacity-25" loading="eager"/>
  <div class="absolute inset-0 bg-gradient-to-br from-brand-dark via-brand-dark/80 to-brand-brown/40"></div>
  <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    <span class="inline-block bg-brand-orange/20 border border-brand-orange text-brand-orange text-sm font-semibold uppercase tracking-widest px-5 py-2 rounded-full mb-6">Категория</span>
    <h1 class="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight mb-5"><span class="text-brand-orange"><?php single_term_title(); ?></span></h1>
    <p class="text-xl text-gray-300 max-w-2xl mx-auto"><?php echo wp_strip_all_tags( term_description() ); ?></p>
  </div>
</section>
...
<div class="bg-brand-ltGray border-b border-gray-200">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
    <nav class="flex items-center gap-2 text-sm text-gray-500">
      ...
      <span>/</span>
      <span class="text-brand-dark font-medium"><?php single_term_title(); ?></span>
    </nav>
  </div>
</div>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
  <div class="flex flex-col lg:flex-row gap-10">
    ...
    <main class="w-full flex flex-col gap-16 pb-20">
      <section id="category-products" class="scroll-mt-28">
